...
const ProfilePage = () => {
  ...
  const stats = {
    artworks: artworksCount, // ✅ استخدام artworksCount مباشرة
  ...
  const handleSaveEdit = async () => {
    ...
    try {
      ...
      alert("❌ فشل في تحديث البروفايل: " + (err.response?.data?.message || err.message));
    }
  };
