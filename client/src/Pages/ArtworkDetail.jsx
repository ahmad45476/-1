...
console.log('🔍 هل العمل مشترى؟', {
  ...
  hasBeenPurchased
        ...
        // ✅ حساب شرط ظهور زر الشراء
        // ✅ الشرط الجديد: يسمح للفنان الأصلي بالشراء إذا كان لست المالك
...
// دالة الشراء المعدلة بالكامل - نسخة آمنة
const handlePurchase = async () => {
  ...
  try {
    ...
    // ✅ تحديث حالة العمل محلياً - مع التحقق من وجود البيانات
    const ownerData = {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
          ...
          <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-2xl p-8">
            <div className="mb-8">
              ...
              {/* عرض معلومات المالك */}
             {/* عرض معلومات المالك - نسخة محسنة تعرض المالك الجديد فوراً */}
<div className="flex items-center mb-6">
  <img
    src={`http://localhost:5000${
      // إذا كان العمل قد تم شراؤه، اعرض بيانات المالك الجديد من artwork.owner
