...
const EditArtwork = () => {
  ...
  const fetchArtworkData = async () => {
    try {
      ...
      const isOwner = currentUser?.artistProfile?._id === artworkData.owner?._id;
  ...
  // ✅ دالة Mint على البلوكشين (أضفها بعد fetchArtworkData وقبل handleSubmit)
const mintArtworkOnChain = async (artworkData, priceInWei) => {
 ...
 const handleSubmit = async (e) => {
  ...
  try {
    ...
    // ✅ Mint إذا كان العمل ليس NFT بعد
