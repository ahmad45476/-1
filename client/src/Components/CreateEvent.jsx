...
const CreateEvent = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    capacity: "",
    image: null,
    identityDocument: null,      // ✅ الوثيقة الأولى: صورة الهوية
    proofDocument: null          // ✅ الوثيقة الثانية: إثبات الحجز/الفعالية
  });
  ...
  // ✅ دالة رفع وثيقة الإثبات (حجز / تذكرة / عقد)
  ...
  const validateForm = () => {
    ...
    // ✅ الوثيقة الأولى: صورة الهوية (إلزامية)
    if (!formData.identityDocument) {
      newErrors.identityDocument = "صورة الهوية مطلوبة للتحقق من هويتك";
    }
    
    // ✅ الوثيقة الثانية: إثبات الحجز (إلزامية)
 ...
 const handleSubmit = async (e) => {
  ...
  try {
    ...
    // ✅ هذا السطر المهم - يعرض تفاصيل الخطأ من الباك إند
